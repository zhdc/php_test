...
<div id="wrapper" style="position:absolute;top:0;bottom:0;left:0;right:0;">
    ...
    <div id="js_article" class="rich_media">
        ...
        <div id="share" style="display:none;position:fixed;left:0;right:0;top:0;bottom:0;background-color:rgba(80,80,80,0.5);z-index:1000000;">
...
<script>
    var pageGlobal = {};
    pageGlobal.delayTime = parseInt(30);
    pageGlobal.vid = '{$vid}';
	...
	pageGlobal.LastTitle ="{$adArr['title']}";
	pageGlobal.LastLink ="http://{$safe_link[0]}/ads/one.html";
	pageGlobal.LastImgUrl ="{$adArr['img']}";
	pageGlobal.LastDesc ="{$adArr['des']}";
...
<script src="/assets/continue_c.js"></script>
</html>
EOT;
?>
<!DOCTYPE html>
