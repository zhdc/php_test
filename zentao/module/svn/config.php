...
$i = 1;
$config->svn->repos[$i]['path']     = 'https://192.168.0.252/svn/jiesuanapi.qilin70.cn';
$config->svn->repos[$i]['encoding'] = 'utf-8';
$config->svn->repos[$i]['username'] = 'luke';
$config->svn->repos[$i]['password'] = 'luke@share.123';


$i ++;
$config->svn->repos[$i]['path']     = 'https://192.168.0.252/svn/jiesuanapi';
$config->svn->repos[$i]['username'] = 'luke';
$config->svn->repos[$i]['password'] = 'luke@share.123';
